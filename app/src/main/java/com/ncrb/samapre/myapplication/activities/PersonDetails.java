...
public class PersonDetails extends AppCompatActivity {
    ...
    private String FIR_REG_NUM_detail, ACCUSED_SRNO_detail;
     ...
     String  section, DISTRICT_CD,PS_CD,FIR_NUMBER_ONLY,FIR_YEAR_ONLY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myfragmentTransaction.add(R.id.activity_person_details, PersonDetailsFragment.newInstance(full_name, alias, relation_type, relative_name,AccusedSrno,   FullRegnum )).commit();
